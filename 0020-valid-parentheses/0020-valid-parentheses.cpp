...
//........Stack ......
// here i can think of is using a stack to track open brackets so basically I scan the string left to right and if i see opening bracket , i will push the code onto stack and if i see closing bracket i check if the stac k is empty -> return false and if the top of stack is matchin opening bracket -> pop it a nd if it is mismatch -> return fasle At the end, the stack should be empty for the string to be valid.
