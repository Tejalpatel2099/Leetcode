...
//Time Complexity: O(n) We loop through all n characters in the string exactly once. and push and pop opeartion on stack is O(1). so total O(n)and n is  length of input string.
