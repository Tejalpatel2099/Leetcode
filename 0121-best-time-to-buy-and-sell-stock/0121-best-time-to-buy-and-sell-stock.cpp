...
// Why Greedy? Because we only care about the minimum price so far and the best profit we can get from today’s price — we don’t backtrack or consider all pairs.
// We try to buy at the lowest price seen so far, and sell at the current price if it gives the best profit.
